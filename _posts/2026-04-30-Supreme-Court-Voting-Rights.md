---
title: "The Supreme Court Voting Rights Ruling: An Explainer For Non-Americans"
description: "An explainer of the Louisiana v. Callais ruling, how US gerrymandering works, and why the decision further weakens minority voting power."
date: 2026-04-30 09:45:00+0300
---

# The Supreme Court Voting Rights Ruling: An Explainer For Non-Americans
...
That is the baseline. Keep it in mind, because the American story we're about to unfold is an excellent illustration of the [Overton window](https://en.wikipedia.org/wiki/Overton_window) in action: how far a system can gradually drift from that baseline while continuing to call itself a democracy.

## Why America Started With A Complicated System
...
- **Packing** means drawing a district that concentrates as many of your opponents' voters as possible into one district. They win that district by an enormous margin — say, 82% to 18%. But those surplus votes beyond the 51% that would've been needed to win are, in effect, wasted. They elected one representative when they could have influenced several districts if distributed differently.
- **Cracking** means taking a community of voters that is concentrated enough to swing a district if kept together, and splitting them across several districts. In each district they are a minority. They win nothing, despite being numerous enough to deserve representation.
...
## When Gerrymandering Became a Precision Weapon
...
## The Pushback: The Voting Rights Act and Racial Gerrymandering
...
## The Weaponization of "Racial Blindness"
...
## Structural Corruption, Measured Against First Principles
