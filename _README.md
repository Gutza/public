...
```ps1
docker run --rm -it -p 4000:4000 -p 35729:35729 -v "${PWD}:/srv/jekyll" -v "${PWD}/vendor/bundle:/usr/local/bundle" -e "BUNDLE_PATH=/usr/local/bundle" jekyll/jekyll:4 sh -lc "git config --global --add safe.directory /srv/jekyll; jekyll serve --host 0.0.0.0 --livereload --force_polling"
```
